...
public class CartSQL {
	final static String LIST = "select c.C_SEQ, c.M_EMAIL, c.P_CODE, p.P_NAME, p.P_PRICE, p.P_IMG, c.C_AMOUNT, c.C_VALID from CART c, PRODUCT p where c.P_CODE = p.P_CODE and c.M_EMAIL=?  and c.C_VALID='Y' order by c.P_CODE"; 
