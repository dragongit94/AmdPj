...
<body>
  ...
  <div class="container">
    <div class="row">
            ...
            <tbody>
			   ...
			   <c:forEach items="${boardNVO.list}" var="BoardN">
                    <tr>
						...
						<td><a href="board_n.do?m=content&bn_seq=${BoardN.bn_seq}">${BoardN.bn_subject}</a></td>
		...
		<div align='center'>
       		<c:choose>
          		<c:when test="${loginUser.m_name=='관리자'}">
					<a href="board_n.do?m=write" class="btn btn-success">글쓰기</a>
				</c:when>
				<c:otherwise>
				</c:otherwise>
          	</c:choose>
