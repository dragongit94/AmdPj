...
<body>
  ...
  <header class="masthead" style="background-image: url('../img/hbaf-bg3.png')">
	...
	<div class="container">
	  ...
	  <strong><a class="navbar-brand" href="board_n.do">공지게시판</a></strong>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <form name="input" method="post" action="board_n.do?m=insert">
			글작성<br/><br/>
			<table class="table table-striped table-hover">
			  <tr>
				 <td width="10%" align="center">WRITER</td>
				 <td><input type="text" name="writer" class="form-control" value="관리자" readonly></td>
			  </tr>
			  <tr>
				 <td align="center">EMAIL</td>
				 <td><input type="text" name="email" class="form-control" value="admin@gmail.com" readonly></td>
			  </tr>
			  <tr>
				 <td align="center">SUBJECT</td>
				 <td><input type="text" name="bn_subject" class="form-control"></td>
			  </tr>
			  <tr>
				 <td align="center">CONTENT</td>
				 <td><textarea  name="bn_content" rows="5" class="form-control"></textarea></td>
			  </tr>
			</table>
			<div align='right'>            
