    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
           <a class="nav-link" href="../cart/cart.do">장바구니</a>
          </li>
          <li class="nav-item">
        ...
        <form name="input" method="post" action="board_q.do?m=update">
			...
			<table class="table table-striped table-hover">
			  <tr>
				 ...
				 <td><input type="text" name="writer" value="${boardQ.m_name}" class="form-control" readonly> </td>
			  </tr>
			  <tr>
				 <td align="center">EMAIL</td>
				 <td><input type="text" name="email" value="${boardQ.m_email}"class="form-control" readonly> </td>
			  </tr>
			  <tr>
				 <td align="center">SUBJECT</td>
				 <td><input type="text" name="subject" value="${boardQ.bq_subject}" class="form-control"> </td>
			  </tr>
			  <tr>
