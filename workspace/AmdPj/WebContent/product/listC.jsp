...
<body>
	...
	<div class="container">
		<div class="dropdown">
            ...
            <div class="dropdown-content">
			      ...
			      <c:choose>
			      <c:when test="${listResult.totalCount==19}">
			      		<strong><a class="navbar-brand" href="product.do?m=listC&cp=1&ps=16&p_type=1">아몬드</a></strong>
					...
					<c:otherwise>
						<a class="navbar-brand" href="product.do?m=listC&cp=1&ps=16&p_type=1">아몬드</a>
			      		<strong><a class="navbar-brand" href="product.do?m=listC&cp=1&ps=16&p_type=2">etc</a></strong>
			      </c:otherwise>
				</c:choose>
			</div>
		</div>
  ...
  <div style="text-align:center;font-size:1.5em;font-family:'Nanum Gothic'">
    ...
    <c:forEach begin="1" end="${listResult.totalPageCount}" var="i">
        <a href="product.do?m=listC&cp=${i}">
           <c:choose>
